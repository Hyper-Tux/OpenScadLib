...
//    {
//        echo (str("test : ", len(children(i))));
//        coul = [colA[0]+stepR*i, colA[1]+stepG*i, colA[2]+stepB*i, colA[3]+stepA*i];
//        color(coul) children(i);
//        echo(coul);
//    }
    
    for (c=children([0:$children-1]))
        color([colA[0]+stepR*i, colA[1]+stepG*i, colA[2]+stepB*i, colA[3]+stepA*i]) c;
}
